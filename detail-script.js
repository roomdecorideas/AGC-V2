document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateMainContent(term) {
        ...
        // ▼▼▼ PERUBAHAN DI SINI: Meminta gambar utama yang tinggi (400x600) ▼▼▼
        const imageUrl = `https://tse1.mm.bing.net/th?q=${encodeURIComponent(term)}&w=400&h=600&c=7&rs=1&p=0&dpr=1.5&pid=1.7`;
    ...
    window.handleRelatedSuggest = function(data) {
        ...
        suggestions.forEach(relatedTerm => {
            ...
            // ▼▼▼ PERUBAHAN DI SINI: Meminta gambar related posts yang tinggi (240x360) ▼▼▼
            const imageUrl = `https://tse1.mm.bing.net/th?q=${encodeURIComponent(relatedTerm)}&w=240&h=360&c=7&rs=1&p=0&dpr=1.5&pid=1.7`;
